    ...
    class OffersAdapter extends RecyclerView.Adapter<OffersAdapter.OffersViewHolder> {
       private List<OfferObject> offerObjectList;
        ...
        public void onBindViewHolder(@NonNull OffersViewHolder holder, int position) {
            ...
            holder.offerName.setText(offerObject.getName());
            holder.companyName.setText(offerObject.getCompanyId());

            if (offerObject.getTags().get(0) != null) {
                holder.tag1.setText(offerObject.getTags().get(0));
            }

            if (offerObject.getTags().get(1) != null) {
                holder.tag1.setText(offerObject.getTags().get(1));
            }

            if (offerObject.getTags().get(2) != null) {
                holder.tag1.setText(offerObject.getTags().get(2));
            }
        ...
        class OffersViewHolder extends RecyclerView.ViewHolder {
            ...
            //Faltan campos
            TextView offerName, companyName, tag1, tag2, tag3;

            public OffersViewHolder(@NonNull View itemView) {
                super(itemView);

                offerName = itemView.findViewById(R.id.offerName);
                companyName = itemView.findViewById(R.id.offerName);
